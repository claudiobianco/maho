...
class Maho_Blog_Model_Resource_Post extends Mage_Eav_Model_Entity_Abstract
{
    ...
    protected function _beforeSave(\Maho\DataObject $object): self
    {
        ...
        // an img src). So mask real directives ({{keyword ...}}) first and restore them after
        // filtering; anything else wrapped in braces (e.g. {{<script>...}}) is left for the filter
        // to strip. getFilteredContent() sanitizes again after resolving the directives, so a
        // crafted directive parameter cannot inject markup on output either.
